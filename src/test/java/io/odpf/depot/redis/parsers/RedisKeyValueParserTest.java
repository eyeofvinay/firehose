...
public class RedisKeyValueParserTest {
    ...
    public void parse() {
        ...
        RedisSinkConfig redisSinkConfig = ConfigFactory.create(RedisSinkConfig.class, config);
    ...
    public void shouldThrowExceptionWhenKeyTemplateIsEmpty() {
        ...
        RedisSinkConfig redisSinkConfig = ConfigFactory.create(RedisSinkConfig.class, singletonMap("SINK_REDIS_KEY_TEMPLATE", ""));
        RedisKeyValueParser redisKeyValueParser = new RedisKeyValueParser(testKeyProtoParser, redisSinkConfig, null);
